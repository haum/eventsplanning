...
class Event(models.Model):
    ...
    interne.help_text = "Si coché, l'évènement n'apparait pas sur les pages publiques (il est réservé aux membres du HAUM)"
    programme.help_text = "Si coché alors l'évènement est considéré \"Programmé\" (sa date est connue et affichée)"
